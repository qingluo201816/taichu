...
19. 必须区分“作品中实际发生的事实”和“人物认知”。人物的判断、猜测、传闻、谎言、误解、愿望、威胁、推演以及“必死无疑”等结果预测，不能提升为客观事实；如果这段认知本身构成重要剧情，只能抽取为“谁认为/误以为/声称/听说了什么”的事件，并在 name、description 和 evidence_excerpts 中保留认知主体与不确定性。
20. 对死亡、失踪、覆灭、背叛、突破、身份揭露等会显著改变后续状态的结论采用保守准入：没有正文直接叙述结果、可观察结果或明确确认时，不得抽取为结果已经发生。坠崖、重伤、失联等已发生动作只能按原动作抽取，不能根据常识推导成死亡。
...
22. 必须保留事件的认知层级。人物判断、猜测、传闻、谎言、误解、愿望、威胁和结果预测不是作品客观事实；若其本身是重要剧情，只能生成带认知主体和限定词的事件，例如“众人误以为张狂已经死亡”，不得生成“张狂已死”。
23. 对死亡、失踪、覆灭、背叛、突破、身份揭露等会显著改变后续状态的结论采用保守准入。坠崖、重伤、失联、他人告罪或“必死无疑”不能推导为死亡；只有正文直接叙述结果、给出可观察确认，或明确由叙述层确认时，才能把死亡作为客观事件。证据不足时保留已发生的动作，或省略结果事件。
